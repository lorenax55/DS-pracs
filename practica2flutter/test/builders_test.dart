import 'package:flutter_test/flutter_test.dart' show expect, group, test, equals, throwsException;
...
void main() {
  group('Builder Tests', () {
    ...
    test('CroquetaRecetaBuilder crea una croqueta', () {
      ...
      expect(receta.ingredientes, equals('Leche, harina, mantequilla, jamón, huevo, pan rallado, aceite'));
      expect(receta.pasos, equals('Hacer una bechamel con la leche, la harina y la mantequilla. Añadir el jamón y dejar enfriar. Formar las croquetas, pasar por huevo y pan rallado y freír en aceite caliente.'));
